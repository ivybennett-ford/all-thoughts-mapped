...
# Use a method to warn for missing information

def add_gamers(gamer, gamers_list):
...
The Homely Wenches are pleased to host "{game}" night this coming {day_of_week}. Hope to see you there!
...
second_best_night = build_daily_frequency_table()
calculate_availability(unable_to_attend_best_night, second_best_night)
...
available_second_game_night = available_on_night(gamers, second_best_night)
send_email(available_second_game_night, second_best_night, "Abruptly Goblins!")
```
